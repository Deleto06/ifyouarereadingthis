...
void TcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TcpServer::*)(const QString & )>(_a, &TcpServer::clientConnected, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TcpServer::*)(const QString & )>(_a, &TcpServer::clientDisconnected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TcpServer::*)(const QString & , const QByteArray & )>(_a, &TcpServer::dataReceived, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (TcpServer::*)(const QString & )>(_a, &TcpServer::errorOccurred, 3))
            return;
    }
}
...
// SIGNAL 2
void TcpServer::dataReceived(const QString & _t1, const QByteArray & _t2)
{
